    ...
    <React.Fragment>
      ...
      <Container maxWidth="xl">
        <Box sx={{ bgcolor: "#fff", height: "auto", borderRadius: ".90rem" }}>
          <form>
            <h1 className=""orm-title""Add new Video</h1>
            <Divider />
            <h3 className=""orm-subtitle""General informations</h3>
            <Divider />
            <div className=""orm-container-fields""
              <TextField
                {...register("name")}
            ...
            <Divider />
            <h3 className=""orm-subtitle""Uploads</h3>
            <Divider />
            <div className='"orm-container-fields'"
              ...
              />
              <label className="image-upload-title" htmlFor="image-upload"> Video thumbnail <Typography
                variant="inherit" className="text-danger">
            ...
            <div className="form-container-fields ">
              <Button type="submit" onClick={handleSubmit(handleSubmitForm)} className=" mb-d1 submit-form-button"
                      variant="contained" color="red">Save video</Button>
            </div>
          </form>
        </Box>
      </Container>
